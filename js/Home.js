    ...
    innerHtml = `${innerHtml}
      <tr>
        ...
        <td class="action-group">
          <img id ="${empPayrollData._id}" src="../assets/icons/delete.png" alt="Delete" onClick="remove(this)">
          <img id ="${empPayrollData._id}" src="../assets/icons/edit icon.png" alt="Edit" onClick="update(this)">
        </td>
      </tr>`
      ;
  }
